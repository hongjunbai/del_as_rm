...
If there is any file/dir have the same name as the to-be-removed file in _~/.Trash_, the filename of new file will be kept as is, while a data-time postfix will be added to the filename of the old file in _~/.Trash_.
